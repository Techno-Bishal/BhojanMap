  ...
  return (
    <form onSubmit={updateProfileHandler} className="max-w-7xl mx-auto my-5">
      ...
      <div className="grid md:grid-cols-4 md:gap-2 gap-3 my-10">
        <div className="flex items-center gap-4 rounded-sm p-2 bg-gray-100 dark:bg-gray-800">
          ...
          <div className="w-full">
            ...
            disabled
              ...
              onChange={changeHandler}
              className="w-full text-gray-700 dark:text-gray-300 bg-transparent focus-visible:ring-0 focus-visible:border-transparent outline-none border-none"
            />
          </div>
        </div>
        <div className="flex items-center gap-4 rounded-sm p-2 bg-gray-100 dark:bg-gray-800">
        ...
        <div className="flex items-center gap-4 rounded-sm p-2 bg-gray-100 dark:bg-gray-800">
          <MapPinnedIcon className="text-gray-500 dark:text-gray-400" />
          <div className="w-full">
